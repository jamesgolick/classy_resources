...
Gem::Specification.new do |s|
  ...
  s.summary = %q{Instant ActiveResource compatible resources. Think resource_controller, for sinatra.}
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sinatra-sinatra>, ["~> 0.9.0.4"])
    else
      s.add_dependency(%q<activesupport>, ["= 2.2.2"])
      s.add_dependency(%q<sinatra-sinatra>, ["~> 0.9.0.4"])
    end
  else
    s.add_dependency(%q<activesupport>, ["= 2.2.2"])
    s.add_dependency(%q<sinatra-sinatra>, ["~> 0.9.0.4"])
